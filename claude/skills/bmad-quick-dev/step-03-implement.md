...
If `graphify-out/GRAPH_REPORT.md` exists, read it and use god nodes and community structure to navigate to the right files. For dependency tracing, query `graphify-out/graph.json` to find callers/callees of functions you will modify.
