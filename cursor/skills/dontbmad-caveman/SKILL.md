...
Code/commits/PRs: write normal syntax. BMAD artifacts (PRDs, stories, architecture docs): write normal — those are human deliverables. "stop caveman" or "normal mode": revert. Level persist until changed or session end.
